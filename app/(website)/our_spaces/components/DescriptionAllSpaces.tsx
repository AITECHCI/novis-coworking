        ...
        <section className="container min-h-[300px] py-14 relative">
            ...
            <div className="relative flex flex-col-reverse md:gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <div className="mt-4 md:mt-0">
                    ...
                    <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                        ...
                        Novis Lille Villeneuve d&apos;Ascq prend place dans un complexe prime écoresponsable, labellisé WELL niveau Silver, à deux pas du Stade Pierre Mauroy.
                    </p>
                    <Link
                        className={cn(
                            buttonVariants({ size: "sm" }),
            ...
            <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                ...
                <div className="mt-4 md:mt-0">
                    ...
                    <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                        ...
                        Ce lieu de réflexion peut accueillir <span className="font-bold">10 à 14 personnes</span> si nécessité de rallonge.
                    </p>
                    <Link
                        className={cn(
                            buttonVariants({ size: "sm" }),
            ...
            <div className="relative flex flex-col-reverse md:gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <div className="mt-4 md:mt-0">
                    ...
                    <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
                        Les espaces communs sont des espaces de grande convivialité pouvant servir à différents types d&apos;évènements comme <span className="font-bold">soirées networking, apéros business, expositions, etc.</span> <br />
                        Ce lieu se prête à la réalisation de tous vos projets commerciaux et artistiques.
                    </p>
                    <Link
                        className={cn(
                            buttonVariants({ size: "sm" }),
