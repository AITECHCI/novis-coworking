...
export default function DescriptionAllSpaces({ offre1 }: { offre1: any }) {
  return (
    <section className="container min-h-[300px] mb-14 relative">
      <div className="relative gap-8 items-center md:items-stretch py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div className="mt-4 md:mt-0">
          ...
          {offre1.description &&
            offre1.description.map((des: any, key: number) => {
              return (
                <p
                  key={key}
          ...
          {offre1.horraires && (
            <ul className="my-10 px-5 mt-2 space-y-1 list-disc list-inside">
              ...
              {offre1.horraires.map((horraire: any, key: number) => {
                return (
          ...
          <Link
            ...
            href={offre1.bookingLink ?? `/reservation`}
          >
      ...
      {offre1.avantages && (
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          ...
          <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-3">
            {offre1.avantages.map((avantage: any, key: number) => {
              return (
                <div
                  key={key}
      ...
      {offre1.elements && (
        <div className="bg-gray-900 py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            {offre1.elements.map((el: any, key: number) => {
              return (
                <div key={key}>
