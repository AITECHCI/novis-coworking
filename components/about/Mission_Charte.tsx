    ...
    return (
        <section className="container min-h-[300px] py-14 relative">
            <div className="bg-black">
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-8">
                        <Image className="w-full rounded-lg row-span-2" src="/images/coworking/Bureaux privés/Bureau prospérité/img (3).jpg" alt="office content 1" width={800} height={600} />
                        <Image className="mt-4 w-full lg:mt-10 rounded-lg" src="/images/coworking/Espace Bulle Open space/img (1).jpg" alt="office content 2" width={800} height={600} />
                        <Image className="mt-4 w-full lg:mt-10 rounded-lg" src="/images/coworking/Bureaux privés/Bureau détermination/img (1).jpg" alt="office content 2" width={800} height={600} />
                    </div>
                </div>
            </div>
            <div className="relative gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <Image className="w-full" src="/images/coworking/Bureaux privés/Bureau confiance/img (2).jpg" alt="dashboard image" width={1037} height={691} />
