        ...
        <div className="mr-4 hidden md:flex">
            ...
            <NavigationMenu className="hidden items-center space-x-6 text-sm font-medium xl:flex">
                <NavigationMenuList>
                    ...
                    <NavigationMenuItem>
                        <Link href={menuList[3].menus[0].href} legacyBehavior passHref>
                            <NavigationMenuLink className={cn(navigationMenuTriggerStyle(), `${menuList[3].menus[0].active && "font-bold text-novis_orange"}`)} >
