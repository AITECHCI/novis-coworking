        ...
        <NavigationMenuList>
          <NavigationMenuItem>
            <Link href={menuList[0].menus[0].href} legacyBehavior passHref>
              <NavigationMenuLink
                className={cn(navigationMenuTriggerStyle(), `${menuList[0].menus[0].active && "font-bold text-novis_orange"}`)}
              >
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                {menuList[1].menus[0].submenus.map((item, index) => (
                  <ListItem key={`submenu-${index}`} href={item.href} title={item.label} className={cn(`${item.active && "font-bold text-novis_orange"}`)} />
                ))}
              </ul>
              <GridPattern
                squares={[
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                {menuList[3].menus[0].submenus.slice(0, 3).map((item, index) => (
                  <ListItem
                    key={`submenu-${index}`}
                    href={item.href}
                    title={item.label}
          ...
          <NavigationMenuItem>
            <Link href={menuList[4].menus[0].href} legacyBehavior passHref>
              <NavigationMenuLink
                className={cn(navigationMenuTriggerStyle(), `${menuList[4].menus[0].active && "font-bold text-novis_orange"}`)}
              >
          ...
          <NavigationMenuItem>
            <Link href={menuList[5].menus[0].href} legacyBehavior passHref>
              <NavigationMenuLink
                className={cn(navigationMenuTriggerStyle(), `${menuList[5].menus[0].active && "font-bold text-novis_orange"}`)}
              >
